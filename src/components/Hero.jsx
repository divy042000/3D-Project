  ...
  return (
    <section className="relative w-full h-screen mx-auto">
     <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
      ...
      <div>
      <h1 className={`${styles.heroHeadText} text-white `}> Hi, I'm <span className=" animate-pulse bg-gradient-to-r from-[#6004eb] to-[#c8a3ff] text-transparent bg-clip-text ">Divy</span></h1>
